      ...
      <div className="container mx-auto px-4 py-8 max-w-6xl">
        ...
        <section className="mb-12">
          ...
          <div className="prose prose-invert max-w-none mb-8">
            <div className="bg-gray-100 dark:bg-ml-bg-secondary p-6 rounded-lg mb-6">
              <h3 className="text-xl font-semibold mb-4 text-gray-900 dark:text-gray-900 dark:text-white">为什么需要评估指标？</h3>
              <p className="text-white leading-relaxed mb-4">
                在监督学习中，我们需要定量地评估模型的性能。不同的应用场景对模型有不同的要求：
              </p>
              <ul className="space-y-2 text-gray-900 dark:text-gray-900 dark:text-white">
            ...
            <div className="bg-gray-100 dark:bg-ml-bg-secondary p-6 rounded-lg">
              <h3 className="text-xl font-semibold mb-4 text-gray-900 dark:text-gray-900 dark:text-white">混淆矩阵 (Confusion Matrix)</h3>
              <p className="text-white leading-relaxed mb-4">
        ...
        <section className="mb-12">
          ...
          <div className="bg-gray-100 dark:bg-ml-bg-secondary p-6 rounded-lg mb-8">
            <h3 className="text-xl font-semibold mb-4 text-gray-900 dark:text-gray-900 dark:text-white">什么是 ROC 曲线？</h3>
            <p className="text-white leading-relaxed mb-4">
          ...
          <div className="bg-gray-100 dark:bg-ml-bg-secondary p-6 rounded-lg mb-8">
            <h3 className="text-xl font-semibold mb-4 text-gray-900 dark:text-gray-900 dark:text-white">AUC 的含义</h3>
            <p className="text-white leading-relaxed mb-4">
        ...
        <section className="mb-12">
          ...
          <div className="bg-gray-100 dark:bg-ml-bg-secondary p-6 rounded-lg mb-6">
            <h3 className="text-xl font-semibold mb-4 text-gray-900 dark:text-gray-900 dark:text-white">偏差-方差权衡</h3>
            <p className="text-white leading-relaxed mb-4">
              模型的泛化误差可以分解为三个部分：
            </p>
            <div className="grid md:grid-cols-3 gap-4 mb-6">
              <div className="bg-gray-100 dark:bg-ml-bg-dark p-4 rounded border-l-4 border-red-500">
              ...
              <div className="bg-gray-100 dark:bg-ml-bg-dark p-4 rounded border-l-4 border-gray-500">
            ...
            <p className="text-white text-sm italic bg-gray-100 dark:bg-ml-bg-dark p-4 rounded">
        ...
        <section className="mb-12">
          ...
          <div className="space-y-6">
            <div className="bg-gray-100 dark:bg-ml-bg-secondary p-6 rounded-lg border-l-4 border-ml-yellow">
            ...
            <div className="bg-gray-100 dark:bg-ml-bg-secondary p-6 rounded-lg border-l-4 border-purple-500">
            ...
            <div className="bg-gray-100 dark:bg-ml-bg-secondary p-6 rounded-lg border-l-4 border-green-500">
              <h3 className="text-lg font-semibold mb-3 text-green-400">💪 练习3：解释 AUC</h3>
              <p className="text-white mb-3">
                思考题：为什么 AUC 是一个好的综合性能指标？
              </p>
              <details className="bg-gray-100 dark:bg-ml-bg-dark p-4 rounded cursor-pointer">
        ...
        <nav className="border-t-2 border-gray-700 pt-8">
          <div className="flex justify-between items-center">
            ...
            <div className="text-center">
              <p className="text-white text-sm mb-1">下一章</p>
