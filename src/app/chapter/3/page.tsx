...
export default function Chapter3() {
  return (
    <div className="min-h-screen bg-white dark:bg-ml-bg-dark text-gray-900 dark:text-white transition-colors">
      {/* 顶部导航栏 */}
      <nav className="bg-gray-100 dark:bg-ml-bg-secondary border-b border-gray-700 sticky top-0 z-10 backdrop-blur-sm bg-opacity-90">
      ...
      <div className="container mx-auto px-4 py-8 max-w-6xl">
        ...
        <section className="mb-12">
          <div className="bg-gradient-to-r from-ml-blue/10 to-purple-600/10 border-l-4 border-ml-blue p-6 rounded-lg">
            ...
            <ul className="space-y-3 text-gray-900 dark:text-gray-900 dark:text-white">
        ...
        <section className="mb-12">
          ...
          <div className="bg-gray-100 dark:bg-ml-bg-secondary p-6 rounded-lg mb-8">
            <h3 className="text-xl font-semibold mb-4 text-gray-900 dark:text-gray-900 dark:text-white">什么是线性回归？</h3>
            <p className="text-white leading-relaxed mb-4">
              线性回归试图学习一个线性函数来拟合数据，是最简单但也最常用的回归模型。
              给定数据集 D，线性回归试图学到一个函数来映射输入和输出的关系：
            </p>
            <div className="bg-gray-100 dark:bg-ml-bg-dark p-4 rounded text-center my-4">
          ...
          <div className="bg-gray-100 dark:bg-ml-bg-secondary p-6 rounded-lg mb-8">
            <h3 className="text-xl font-semibold mb-4 text-gray-900 dark:text-gray-900 dark:text-white">均方误差损失 (MSE Loss)</h3>
            <p className="text-white leading-relaxed mb-4">
            ...
            <div className="grid md:grid-cols-2 gap-4 mt-4">
              <div className="bg-gray-100 dark:bg-ml-bg-dark p-4 rounded">
          ...
          {/* 线性回归交互演示 */}
          <div className="mb-6">
            <h3 className="text-2xl font-semibold mb-4 text-gray-900 dark:text-gray-900 dark:text-white">🎮 交互式演示</h3>
        ...
        <section className="mb-12">
          ...
          <div className="bg-gray-100 dark:bg-ml-bg-secondary p-6 rounded-lg mb-8">
            <h3 className="text-xl font-semibold mb-4 text-gray-900 dark:text-gray-900 dark:text-white">优化的艺术</h3>
            <p className="text-white leading-relaxed mb-4">
            ...
            <div className="bg-gray-100 dark:bg-ml-bg-dark p-6 rounded-lg my-6">
              ...
              <div className="grid md:grid-cols-3 gap-4 text-sm">
                <div className="text-center">
                  ...
                  <p className="text-gray-900 dark:text-gray-900 dark:text-white">待优化的参数</p>
                </div>
                <div className="text-center">
                  <p className="text-ml-yellow font-bold mb-1">α (alpha)</p>
                  <p className="text-gray-900 dark:text-gray-900 dark:text-white">学习率（步长）</p>
                </div>
                <div className="text-center">
                  <p className="text-red-400 font-bold mb-1">∂L/∂θ</p>
                  <p className="text-gray-900 dark:text-gray-900 dark:text-white">损失函数的梯度</p>
                </div>
              </div>
            </div>

            <div className="grid md:grid-cols-2 gap-4">
              <div className="bg-gray-100 dark:bg-ml-bg-dark p-4 rounded border-l-4 border-green-500">
              ...
              <div className="bg-gray-100 dark:bg-ml-bg-dark p-4 rounded border-l-4 border-yellow-500">
          ...
          {/* 梯度下降可视化 */}
          <div className="mb-6">
            <h3 className="text-2xl font-semibold mb-4 text-gray-900 dark:text-gray-900 dark:text-white">🎮 梯度下降可视化</h3>
            <p className="text-white mb-4">
        ...
        <section className="mb-12">
          ...
          <div className="bg-gray-100 dark:bg-ml-bg-secondary p-6 rounded-lg mb-8">
            <h3 className="text-xl font-semibold mb-4 text-gray-900 dark:text-gray-900 dark:text-white">从回归到分类</h3>
            <p className="text-white leading-relaxed mb-4">
            ...
            <div className="bg-gray-100 dark:bg-ml-bg-dark p-6 rounded-lg my-6">
              ...
              <div className="grid md:grid-cols-3 gap-4">
                <div className="bg-gray-100 dark:bg-ml-bg-secondary p-3 rounded text-center">
        ...
        <section className="mb-12">
          ...
          <div className="bg-gray-100 dark:bg-ml-bg-secondary p-6 rounded-lg mb-6">
            <h3 className="text-xl font-semibold mb-4 text-gray-900 dark:text-gray-900 dark:text-white">防止过拟合的利器</h3>
            <p className="text-white leading-relaxed mb-4">
            ...
            <div className="grid md:grid-cols-2 gap-6 mb-6">
              <div className="bg-gray-100 dark:bg-ml-bg-dark p-5 rounded-lg border-l-4 border-blue-500">
              ...
              <div className="bg-gray-100 dark:bg-ml-bg-dark p-5 rounded-lg border-l-4 border-purple-500">
          ...
          <div className="bg-gray-100 dark:bg-ml-bg-secondary p-6 rounded-lg">
            <h3 className="text-xl font-semibold mb-4 text-gray-900 dark:text-gray-900 dark:text-white">L1 vs L2：几何直观</h3>
        ...
        <section className="mb-12">
          <div className="bg-gradient-to-r from-ml-blue/20 to-purple-600/20 border-2 border-ml-blue/50 p-8 rounded-lg">
            ...
            <div className="space-y-3 text-gray-900 dark:text-gray-900 dark:text-white">
        ...
        <nav className="border-t-2 border-gray-700 pt-8">
          <div className="flex justify-between items-center">
            ...
            >
              <span className="text-xl">←</span>
              <div>
                <p className="text-xs text-gray-900 dark:text-gray-900 dark:text-white">上一章</p>
                <p className="font-semibold">模型评估与选择</p>
              </div>
            </Link>
            <Link
              href="/"
              className="px-6 py-3 bg-gray-100 dark:bg-ml-bg-secondary hover:bg-gray-700 rounded-lg transition-colors"
            >
              返回主页
            </Link>
            <Link
            ...
            >
              <div className="text-right">
                <p className="text-xs text-gray-900 dark:text-gray-900 dark:text-white">下一章</p>
