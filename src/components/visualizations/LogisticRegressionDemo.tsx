        ...
        <div className="space-y-6">
          ...
          <div className="bg-gray-100 dark:bg-ml-bg-dark p-4 rounded-lg">
            ...
            <div className="mt-4 pt-4 border-t border-gray-700">
              <p className="text-xs text-white mb-2">决策边界方程:</p>
      ...
      <div className="mt-6 p-4 bg-gray-100 dark:bg-ml-bg-dark rounded-lg">
        <div className="grid md:grid-cols-3 gap-4 text-sm">
          <div>
            ...
            <p className="text-white mt-1">正类样本 (label = 1)</p>
          </div>
          <div>
            <span className="text-red-400 font-bold">● 红色圆点</span>
            <p className="text-white mt-1">负类样本 (label = 0)</p>
          </div>
          <div>
            <span className="text-white font-bold">━ ━ 白色虚线</span>
            <p className="text-white mt-1">决策边界 (P = 0.5)</p>
          </div>
        </div>
